...
class PapersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paper" do
    assert_difference('Paper.count') do
      post papers_url, params: { paper: { content: @paper.content, status: @paper.status, subtheme_id: @paper.subtheme_id, theme_id: @paper.theme_id, title: @paper.title } }
    end
  ...
  test "should update paper" do
    patch paper_url(@paper), params: { paper: { content: @paper.content, status: @paper.status, subtheme_id: @paper.subtheme_id, theme_id: @paper.theme_id, title: @paper.title } }
